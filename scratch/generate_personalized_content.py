...
OUTPUT_MARKDOWN = os.path.join(CACHE_DIR, "personalized_curriculum.md")

os.makedirs(CACHE_DIR, exist_ok=True)

USER_PROFILE = {
    "name": "Vijay Sathappan M",
    "level": "Advanced"
}

# Pre-compiled high-quality personalized curriculum content in English
CURRICULUM_DATA = {
  "0": {
    "title": "1.1 Introduction",
    "markdown": """# 1.1 Introduction: The Game Rules of Measurement
    ...
    "json": [
      {
        ...
        "explanation": "Vijay, let's understand how measurements work. The book defines a unit as 'a certain basic, arbitrarily chosen, internationally accepted reference standard'. Think of it like the rules of cricket: we need a standard yard length for the pitch so that a match played in Mumbai uses the same dimensions as one in London. A measurement always consists of a number and its unit. The units for basic independent quantities are 'fundamental units', and combinations of them are 'derived units'."
      }
    ]
  },
  "1": {
    "title": "1.2 The International System of Units",
    "markdown": """# 1.2 The International System of Units: The Global Rulebook
    ...
    "json": [
      {
        ...
        "explanation": "Before the global SI system, different regions had their own standards. MKS used metre, kilogram, second; CGS used centimetre, gram, second; and FPS used foot, pound, second. It's like different car racing games measuring speed in mph (miles per hour) vs km/h!"
      },
      {
        ...
        "explanation": "To avoid confusion, the BIPM established the SI system. It is a decimal-based system, meaning conversions (like meters to kilometers) are simple multiples of 10, much like credits or coins in gaming menus."
      }
    ]
  },
  "2": {
    "title": "1.3 Significant Figures",
    "markdown": """# 1.3 Significant Figures: Precision in Gaming and Science
    ...
    "json": [
      {
        ...
        "explanation": "When we report a measurement, we include all certain digits plus one last digit that is estimated. If a stopwatch says 1.62 seconds, '1' and '6' are certain, but '2' is slightly uncertain. Together, they make 3 significant figures."
      }
    ]
  },
  "3": {
    "title": "1.3.1 Rules for Arithmetic Operations with Significant Figures",
    "markdown": """# 1.3.1 Rules for Arithmetic Operations: Math with Limits
    ...
    "json": [
      {
        ...
        "explanation": "For multiplication/division, we look at the total number of significant figures (e.g. 5.74 / 1.2 = 4.8). For addition/subtraction, we look at the decimal places (e.g. 436.32 + 227.2 = 663.8). This ensures our calculations reflect real-world measuring constraints."
      }
    ]
  },
  "4": {
    "title": "1.3.2 Rounding off the Uncertain Digits",
    "markdown": """# 1.3.2 Rounding off: The Standard Conventions
    ...
    "json": [
      {
        ...
        "explanation": "This odd/even rule for exactly 5 is designed to keep rounding unbiased. So 2.745 becomes 2.74 (since 4 is even), while 2.735 becomes 2.74 (since 3 is odd). This keeps the average of rounded values stable!"
      }
    ]
  },
  "5": {
    "title": "1.3.3 Rules for Determining the Uncertainty in the Results of Arithmetic Calculations",
    "markdown": """# 1.3.3 Uncertainty in Calculations: The Error Margin
    ...
    "json": [
      {
        ...
        "explanation": "Even though both measurements have the same absolute uncertainty (0.01 g), the relative error of 1.02 g is 1% while that of 9.89 g is only 0.1%. So, measuring larger values generally gives a smaller relative error!"
      }
    ]
  },
  "6": {
    "title": "1.4 Dimensions of Physical Quantities",
    "markdown": """# 1.4 Dimensions of Physical Quantities: The DNA of Units
    ...
    "json": [
      {
        ...
        "explanation": "Dimensions tell us what kind of quantity we are dealing with. Mass is $[M]$, Length is $[L]$, and Time is $[T]$. By combining them, we get derived dimensions. It's like the genetic code of a unit!"
      },
      {
        ...
        "explanation": "Since volume is length × width × height, its dimension is $[L^3]$. We can write it in terms of mass and time as $[M^0 L^3 T^0]$, showing it doesn't depend on mass or time."
      }
    ]
  },
  "7": {
    "title": "1.5 Dimensional Formulae and Dimensional Equations",
    "markdown": """# 1.5 Dimensional Formulae and Dimensional Equations
    ...
    "json": [
      {
        ...
        "explanation": "A dimensional formula is the bracketed expression like $[M L T^{-2}]$ for force. When you write $[F] = [M L T^{-2}]$, you are writing a dimensional equation."
      }
    ]
  },
  "8": {
    "title": "1.6 Dimensional Analysis and its Applications",
    "markdown": """# 1.6 Dimensional Analysis: The Consistency Test
    ...
    "json": [
      {
        ...
        "explanation": "You can only add or subtract quantities that represent the same physical dimension. Adding meters to seconds makes no sense. We use this principle to check if equations are physically possible!"
      }
    ]
  },
  "9": {
    "title": "1.6.1 Checking the Dimensional Consistency of Equations",
    "markdown": """# 1.6.1 Checking consistency: The Homogeneity Principle
    ...
    "json": [
      {
        ...
        "explanation": "This is the 'principle of homogeneity'. If you see an equation like $A + B = C$, then $A$, $B$, and $C$ must have the exact same dimensions. You can't add speed to temperature!"
      }
    ]
  },
  "10": {
    "title": "1.6.2 Deducing Relation among the Physical Quantities",
    "markdown": """# 1.6.2 Deducing Relations among Physical Quantities
    ...
    "json": [
      {
        ...
        "explanation": "If you know a quantity depends on at most 3 other independent physical variables, you can find the formula relating them by equating their powers. This is a very powerful tool in exam prep!"
      }
    ]
  },
  "11": {
    "title": "Summary",
    "markdown": """# Summary: Units & Measurement Core Recap
    ...
    "json": [
      {
        ...
        "explanation": "In summary, remember the 7 base quantities: Length, Mass, Time, Current, Temperature, Amount of Substance, and Luminous Intensity. They form the base of all measurements in physics!"
      }
    ]
  },
  "12": {
    "title": "Exercises",
    "markdown": """# Exercises: Practice Arena
    ...
    "json": [
      {
        ...
        "explanation": "Always remember to round off your final numerical answers to the correct number of significant figures as discussed in Section 1.3!"
      }
    ]
  }
}

FINAL_MARKDOWN_COMPONENTS = """
---
...
def main():
    print("Writing cached JSON files...")
    for idx_str, data in CURRICULUM_DATA.items():
        idx = int(idx_str)
        # Write JSON cache
        json_path = os.path.join(CACHE_DIR, f"physics_class_11_chapter_1_section_{idx}.json")
        with open(json_path, "w", encoding="utf-8") as f:
            json.dump(data["json"], f, ensure_ascii=False, indent=2)
            
        # Write MD cache
        md_path = os.path.join(CACHE_DIR, f"physics_class_11_chapter_1_section_{idx}.md")
        with open(md_path, "w", encoding="utf-8") as f:
            f.write(data["markdown"])
            
        print(f"Cached Section {idx}: {data['title']}")

    print("Compiling final personalized curriculum...")
    complete_markdown = "# Personalized Physics Curriculum: Chapter One: Units and Measurement\n"
    complete_markdown += f"Tailored for **{USER_PROFILE['name']}** (JEE Prep, {USER_PROFILE['level']})\n\n"

    for i in range(13):
        md_path = os.path.join(CACHE_DIR, f"physics_class_11_chapter_1_section_{i}.md")
    ...
    complete_markdown += FINAL_MARKDOWN_COMPONENTS

    with open(OUTPUT_MARKDOWN, "w", encoding="utf-8") as f:
        f.write(complete_markdown)
        
    print(f"Successfully generated offline personalized curriculum at {OUTPUT_MARKDOWN}")
